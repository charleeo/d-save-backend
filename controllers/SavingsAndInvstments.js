...
const individualSavings= async(req,res)=>{
 ...
 else return res.status(404).json({message:"No record found for individual savings"})
}
...
const individualInvestments= async(req,res)=>{
 ...
 else return res.status(404).json({message:"No record found for individual investment"})
}
...
const getInvestmentsSummary = async(req,res)=>{
  ...
  else return res.status(404).json({message:"No record found for investment summary"})
}
// 5000730073 
module.exports = 
{
